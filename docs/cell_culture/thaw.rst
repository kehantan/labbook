...
* Frozen Vero cell stock from LN2 or -80 °C
...
#. Label the flask.  
     ...
     * Label Cell type, cell passage, date, name initials, PI initials (eg: :code:`VERO P20 3/10/2023 TKH/NNR`)
...
#. Incubate. 37 °C, 5% CO2. 
#. Change media after 24 hrs to remove DMSO. This step not necessary if the cryopreservant was removed by centrifuge during before transferred into T25. 