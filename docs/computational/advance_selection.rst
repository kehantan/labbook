...
* To overcome this problem, select the important sections on both the chain, ie: the important interacting site (or interface) between 2 chains, or centering the protein receptor chains by using the residues around the binding site as reference. 

Residues around the binding site as reference
----

* There are 2 chains in the protein receptor and there are 3 important residues which is the catalytic triad. 
